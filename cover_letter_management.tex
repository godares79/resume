...
I am excited to apply for the role of \jobtitle with \company. As a highly motivated and results-driven developer, I believe that my skills and experience will enable me to successfully transition into the role of \textbf{Add title here again}. \par

During my tenure at Google I have worked on cross-functional teams across mobile, backend, and cloud organizations. My work in Android Google Maps saw me solving complex technical problems to deliver significant improvements to developer productivity and pay down tech debt that had been accumulating for a decade. I also became intimately familiar with almost all aspects of test and release pipelines in order to optimize those processes. More recently, my work in Google Cloud led to my designing the cloud infrastructure and release process for a new Cloud product using Kubernetes. During all of this work I set direction, owned the creation and completion of timelines and goals, and provided mentorship for more junior developers on the team. \par

I am highly motivated by complex technical challenges, improving developer productivity, and making an excellent product for the end user. Not only my interests, but also my practical experience, I believe make me an excellent fit for this role in \organization. \par
