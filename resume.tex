...
\item[]
	...
	\begin{itemize}
		\resitem{Lead team tasked with improving developer velocity. We significantly improved test flakiness and test performance, reducing wall time of code submissions from 45 minutes to under 20 minutes. Resulting in 6+ eng-months of waiting time saved per year.}
		...
		\resitem{Designed and built conformance test infrastructure and tests for Android Auto. This suite is shipped to OEMs for verification of their Android Auto implementation in vehicles.}
	\end{itemize}
