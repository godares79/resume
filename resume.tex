...
\begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
	...
	Waterloo, Ontario & \rurl{github.com/godares79} \\
	& \rurl{linkedin.com/in/david-drich}
\end{tabular*}
\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{center}
	  \parbox{6.762in}{Self-directed learner seeking a Senior Software Developer position in a fast-paced and challenging environment. Thrives in ambiguity. Proven tech lead. 10+ years of experience. Strong collaboration skills and several years of experience mentoring junior developers.}
  \end{center}
...
\item[]
	\ressubheading{Google}{USA/Japan/Canada}{Software Engineer - Google Cloud}{Jan 2022 - Current}
	\begin{itemize}
