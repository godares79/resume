...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{center}
	  \parbox{6.762in}{Experienced software developer seeking position in a fast-paced and challenging environment. Thrives in ambiguity. Proven tech lead. Significant experience in both Eng and Eng Productivity roles. Strong technical ability and systems design experience. (Maybe 1 more sentence).}
  \end{center}
...
\item[]
	\textbf{Frameworks:} Bazel, Kubernetes, GCP, Terraform, Git, Jenkins, Cloud Build, Protobuf
\item[]
